...
Este es un requisito de edad. Debes tener al menos 11 años cumplidos para completar Campamento II.

**Razón:**
- Esta especialidad tiene requisitos más exigentes que Campamento I
- Requiere mayor madurez y responsabilidad
- Manejo de herramientas requiere desarrollo físico adecuado
- Capacidad de aplicar conceptos más complejos
...
- Seré paciente cuando otros cometan errores
...
- Usaré solo madera caída para fogatas
- Dejaré el lugar mejor que como lo encontré
...
- Respeta espacio personal
- No tomes cosas sin permiso
- Limpia tu desorden
- Sé puntual
- Escucha activamente
- Anima, no critiques
...
**Orientación de la carpa:**
- Lado angosto de la carpa hacia el viento
- Puerta opuesta al viento predominante
- Estacas y tensores bien asegurados
...
- Marcas en árboles (rasguños, mordidas)
...
- Hormigueros grandes
- Áreas donde animales vienen a beber
...
- Disponibilidad afecta comodidad del campamento
- Recolección puede impactar ecosistema

**Qué buscar:**
- **Disponibilidad:** Suficiente madera caída y muerta
- **Seca:** Madera que truena al quebrarse
- **Variedad de tamaños:** Desde ramitas hasta troncos
- **Accesible:** No muy lejos del campamento

**Tipos de madera:**
- **Para iniciar:** Ramitas finas, corteza seca
- **Para cocinar:** Ramas medianas (mantienen brasa)
- **Para calentar:** Troncos grandes

**Regulaciones:**
- Muchas áreas protegidas prohíben recolectar leña
- Algunas requieren comprar leña traída de fuera
- Nunca cortes árboles vivos
- Respeta cantidades permitidas

**Qué evitar:**
- Áreas sin madera caída (ecosistema necesita madera en descomposición)
- Toda la leña está mojada
- Solo hay árboles vivos
- Área recolectada excesivamente

**Alternativas:**
- Si no hay suficiente leña: usa estufa de camping
- Lleva leña de casa si está permitido
- Minimiza uso de fuego

**Considera:**
- ¿Cuántos días acamparás?
- ¿Cuántas personas?
- ¿Para qué usarás fuego? (cocinar, calor, ambos)
- ¿Hay restricciones de fuego en la época?
...
**Por qué importa:**
- Seguridad durante el campamento
- Comodidad del grupo
- Equipamiento necesario
- Planificación de actividades

**Antes de ir:**
- Revisa pronóstico de 7-10 días
- Conoce clima típico de la zona y época
- Planifica para peor escenario
- Ten plan B para actividades

**Factores a considerar:**

**Temperatura:**
- **Diurna:** Ropa y actividades apropiadas
- **Nocturna:** Saco de dormir adecuado
- **Variación día-noche:** Sistema de capas
- **Sensación térmica:** Viento enfría más

**Precipitación:**
- ¿Probabilidad de lluvia?
- ¿Nieve esperada?
- Impermeables y fundas para mochilas
- Techo extra o toldo para cocinar

**Viento:**
- ¿Vientos fuertes esperados?
- Estacas y tensores extras
- Ubicación protegida

**Tormentas eléctricas:**
- ¿Época de tormentas?
- Identifica refugio seguro
- Evita árboles altos aislados
- Plan de evacuación

**Cómo ajustar campamento según clima:**

**Clima caluroso:**
- Busca sombra
- Cerca de agua para refrescarse
- Ventilación en carpas
...
**Clima lluvioso:**
- Terreno elevado (drena)
- Zanjas alrededor carpas (algunas áreas permiten)
- Todo en bolsas impermeables
- Área cubierta para cocinar

**Señales de cambio climático:**
- Cambios en presión (dolor de cabeza puede indicar tormenta)
- Nubes: cúmulos altos = cambio
- Animales inquietos
- Temperatura súbita baja
- Viento cambia dirección
...
**Regla de los 60 metros (200 pies):**
- Todo campamento, cocina, sanitario a 60m mínimo del agua
- Protege agua de contaminación
- Preserva ecosistema acuático

**Al tomar agua:**
- Toma aguas arriba
- No revuelvas sedimento
- Usa recipiente limpio
- Minimiza pisoteo de orillas

**Al lavar:**
- NUNCA laves directamente en río/lago
- Lleva agua en recipiente 60m lejos
- Usa jabón biodegradable
- Filtra partículas del agua jabonosa
- Desecha en tierra (no de regreso al agua)

**Proteger de contaminación:**
- Sanitarios 60m lejos, aguas abajo
- Sin basura cerca del agua
- Sin comida o restos en el agua
- Si ves contaminación: reporta
...
**Baño personal:**
- 60m lejos de fuente de agua
- Usa balde o ducha solar
- Jabón biodegradable mínimo
- Agua jabonosa en tierra, no en agua

**Cepillado de dientes:**
- Lejos de fuente de agua
- Escupe en tierra
- Cantidades mínimas de pasta

**Ropa:**
- Si lavas ropa: lejos del agua
- Sécala al sol
- Cambia ropa interior/calcetines regularmente
...
- Manos limpias
- Utensilios limpios
- Superficie de preparación limpia
- Cabello recogido
- Sin joyas en manos

**Durante la cocina:**
- Separa crudo de cocido
- Usa tablas diferentes para carnes y vegetales
- Mantén comida cubierta
...
1. **Balde 1 - Lavado:**
   - Agua caliente con jabón biodegradable
   - Raspa comida primero (a basura)
   - Remueve grasa

2. **Balde 2 - Enjuague:**
   - Agua limpia
   - Quita jabón completamente

3. **Balde 3 - Desinfección:**
   - Agua caliente o con cloro
   - Sumerge 1-2 minutos

**Agua residual:**
- Filtra partículas sólidas
- Lleva 60m lejos de fuentes de agua
- Esparce en área amplia (no un solo lugar)
- O cava hueco pequeño, vierte, tapa

**Almacenamiento de comida:**
- En recipientes cerrados
- Protegido de animales
- Lejos de carpas donde duermes
- En lugar fresco
...
- Solo madera caída
- En área ya usada
- Apaga completamente cuando termines

**Basura:**
- TODA la basura contigo
- Separa orgánica, reciclable, no-reciclable
- Bolsas cerradas
- Nunca entierres basura

**Respeto al sitio:**
- No ensucias más del mínimo necesario
- Restaura el área al terminar
- No dejes señales de cocina

**BENEFICIOS DE ESTAS PRÁCTICAS:**
- Agua limpia para todos (humanos y animales)
- Ecosistema saludable
- Prevención de enfermedades
- Área disponible para futuros visitantes
- Honramos a Dios como mayordomos
...
Debes participar activamente en al menos una de estas actividades durante el culto del campamento:

**a) Estudio de la Lección de Escuela Sabática**

**Cómo prepararse:**
- Estudia tu lección durante la semana antes
- Prepara preguntas para el grupo
- Trae tu folleto o Biblia con notas

**Durante la Escuela Sabática:**
- Comparte tus respuestas
- Haz preguntas reflexivas
- Relaciona la lección con la naturaleza
- Escucha activamente a otros
- Si eres líder pequeño grupo: guía la discusión

**Ejemplo:**
"En la lección de esta semana aprendimos sobre la fe de Abraham. Durante nuestra caminata ayer, vi cómo las semillas caen y confían en que darán fruto. Eso me hizo pensar en cómo Abraham confió en Dios sin ver el resultado..."

**b) Historia**

**Tipos de historias apropiadas:**
- Historia misionera
- Testimonio de conversión
- Historia de la naturaleza con lección espiritual
- Relato bíblico dramatizado
- Experiencia personal con Dios

**Cómo prepararla:**
- Elige historia apropiada para la edad del grupo
- Practica en casa
- 5-7 minutos de duración
- Inicio interesante
- Clímax claro
- Cierre con lección espiritual

**Estructura:**
1. **Inicio:** Captura atención ("¿Alguna vez se han preguntado...?")
2. **Desarrollo:** Cuenta la historia vívidamente
3. **Clímax:** Momento de mayor tensión o importancia
4. **Conclusión:** Lección espiritual clara

**Ejemplo tema:**
"La historia de cómo Dios cuidó a Elías junto al arroyo, y cómo los cuervos le llevaban comida. Relacionar con cómo Dios provee para nosotros también."

**c) Testimonio**

**Qué es:**
- Compartir experiencia personal con Dios
- Cómo Dios obró en tu vida
- Respuesta a oración
- Momento de decisión espiritual

**Cómo prepararlo:**
- Sé sincero y personal
- No es un sermón, es tu experiencia
- 3-5 minutos
- Lenguaje simple y claro
- Enfócate en lo que Dios hizo, no en ti

**Estructura de testimonio:**
1. **Antes:** Situación o problema que enfrentaste
2. **Durante:** Cómo Dios intervino
3. **Después:** Cómo cambió tu vida/perspectiva
4. **Invitación:** Anima a otros a confiar en Dios también

**Ejemplo:**
"Quiero compartir cómo Dios me ayudó cuando tuve miedo. Hace unos meses... [cuenta experiencia]... Ahora sé que puedo confiar en Dios incluso cuando tengo miedo. Si alguno de ustedes está pasando por algo similar, los animo a orar y ver cómo Dios actúa."

**Consejos:**
- No inventes o exageres
- Evita nombres de personas (privacidad)
- Sé apropiado para la edad del grupo
- Practica antes para no ponerte muy nervioso

**d) Dirigir los cantos**

**Preparación:**
- Selecciona 4-6 cantos apropiados
- Variedad: alabanza, adoración, reflexivos
- Conoce bien las canciones
- Practica dirigir en casa

**Cómo dirigir:**

**Antes:**
- Llega temprano
- Verifica que todos tengan himnarios/letras
- Decide orden de cantos
- Ten plan B si alguno no funciona

**Durante:**

1. **Introducción:**
   - "Buenos días/tardes, vamos a alabar a Dios"
   - Explica brevemente el primer canto si es necesario

2. **Al dirigir:**
   - Párate donde todos te vean
   - Canta con entusiasmo
   - Mantén contacto visual
   - Marca tiempo con mano
   - Sonríe

3. **Transiciones:**
   - Corta introducción entre cantos
   - O fluye directo al siguiente

4. **Energía:**
   - Empieza con cantos alegres
   - Termina con algo más reflexivo
   - Lee el ambiente del grupo

**Selección de cantos:**
- Conocidos por el grupo
- Apropiados para el momento (mañana=alegres, noche=reflexivos)
- Variedad de ritmos
- Alguno nuevo si quieres enseñar

**Consejos:**
- No te preocupes si no eres cantante perfecto
- Lo importante es tu actitud, no tu voz
- Involucra al grupo ("¿Cuál quieren cantar ahora?")
- Ten backup por si olvidaste letra
...
**[PRÁCTICA REQUERIDA]**
Debes demostrar que sabes encender y usar estos equipos con seguridad.

**FOGÓN O ESTUFA DE CAMPAMENTO:**

**Tipos comunes:**
- Gas propano (bombona)
- Gas butano (cartucho)
- Gasolina blanca (líquida)
- Alcohol
...
1. **Ubicación segura:**
   ...
   - Lejos de carpas (mínimo 2-3 metros)
   - Protegida del viento (o usa paravientos)
   - Área bien ventilada (NUNCA dentro de carpa)
...
3. **Preparación:**
   - Lee manual si es primera vez
   - Ten extintor o agua cerca
   - Cabello recogido
   - Sin ropa suelta cerca

**Al encender (estufa a gas):**

1. Conecta bombona/cartucho correctamente
   - Gira hasta que esté firme
   - Verifica sello hermético

2. Abre válvula de gas lentamente
   - Solo un poco al inicio

3. Enciende inmediatamente
   - Usa encendedor o fósforo
   - Acerca llama al quemador
   - Luego abre gas completamente

4. **NUNCA:**
   - Abras gas y esperes para encender (acumulación peligrosa)
   - Enciendas con cara sobre el quemador
   - Uses si huele mucho a gas

**Durante el uso:**
- Supervisa siempre
- Ajusta llama según necesidad
- Mantén estable, no muevas con olla caliente
- Niños a distancia segura

**Al apagar:**
- Cierra válvula de gas
- Deja que llama se consuma
- Espera que enfríe antes de guardar
- Desconecta si no usarás por tiempo
...
**LÁMPARA LED (más segura):**

1. **Instalación:**
   - Verifica pilas/batería cargada
   - Cierra bien compartimento

2. **Uso:**
   - Cuelga en lugar seguro
   - No dejes en superficial que pueda caer
   - Ajusta intensidad según necesidad

3. **Mantenimiento:**
   - Cambia pilas cuando baja luz
   - Limpia contactos
...
**Antes de usar:**
- Lee instrucciones específicas del modelo
- Verifica camisa (malla) esté intacta
- Inspecciona conexiones

**Encendido:**

1. Conecta cartucho de gas
   - Asegura bien

2. Abre válvula lentamente

3. Enciende con encendedor
   - Acerca por debajo
   - No directamente a la camisa

4. Ajusta intensidad

**Durante uso:**
- Cuelga de gancho seguro
- No muevas mientras está encendida y caliente
- Ventila área (produce monóxido de carbono)
- NUNCA dentro de carpa cerrada
...
1. **Ventilación:** Siempre usa en área ventilada
2. **Supervisión:** Nunca dejes encendido sin vigilancia
3. **Distancia:** Lejos de materiales inflamables
4. **Niños:** Supervisión adulta constante
5. **Combustible:** Guarda lejos de calor
6. **Emergencia:** Sabe cómo apagar rápidamente
7. **Noche:** Apaga todo antes de dormir
8. **Transporte:** Solo mueve cuando esté frío
9. **Almacenamiento:** Desconecta combustible al guardar
10. **Clima:** Protege del viento (puede apagar o avivar peligrosamente)
...
- Gira 360° completo
- NADIE debe estar dentro de ese círculo
- Si alguien entra, detén inmediatamente

**2. INSPECCIÓN DE LA HERRAMIENTA:**
- Hoja afilada (herramienta afilada es más segura)
- Sin óxido excesivo
- Mango sin astillas ni grietas
- Cabeza firme al mango (no suelta)
- Sin abolladuras que desvíen el filo

**3. EQUIPO DE PROTECCIÓN:**
- Zapatos cerrados y firmes (nunca sandalias)
- Pantalones largos
- Guantes si disponibles
- Sin ropa suelta que pueda enredarse

**4. ÁREA DE TRABAJO:**
- Superficie plana y despejada
- Sin obstáculos alrededor
- Buena iluminación
- No trabajar bajo lluvia (resbaladizo)

**5. POSTURA CORRECTA:**
- Pies separados y firmes
- Rodillas levemente flexionadas
- Espalda recta
- Balance estable

**6. CONCENTRACIÓN:**
- Atención total en el trabajo
- No conversar mientras cortas
- No trabajar cansado
- Toma descansos

**7. DIRECCIÓN DE CORTE:**
- Siempre alejándote de tu cuerpo
- Nunca hacia piernas o pies
- Controla el golpe (no violento)

**8. TRANSPORTE:**
- Hacha: cabeza abajo, mano cerca de la cabeza, filo alejado
- Machete: en funda al costado
- Al entregar: por el mango, nunca lanzar
- Avisa cuando vas caminando con herramienta

**9. ALMACENAMIENTO:**
- Hacha: clava en tronco OR en funda
- Machete: siempre en funda
- NUNCA en el suelo (peligro de tropiezo)
- Lugar seco (previene óxido)

**10. SUPERVISIÓN:**
- Adulto presente siempre
...
2. Mínimo 5 metros de carpas
3. Lejos de árboles y ramas
4. Protegida del viento pero ventilada
5. Área designada si existe

**PREPARACIÓN:**
6. Limpia 2-3 metros alrededor
7. Quita todo material inflamable
8. Ten agua o arena cerca para emergencias
9. Verifica que esté permitido hacer fogata

**CONSTRUCCIÓN:**
10. Usa círculo de piedras (no de río)
11. Tamaño controlado (no fogata gigante)
12. Madera seca y caída solamente
13. Estructura estable (no se colapse)

**DURANTE:**
14. NUNCA dejes sin supervisión
15. Mantén niños a distancia segura
16. No agregues plásticos o basura
17. No rocíes líquidos inflamables
18. Controla chispas volando
19. Ten herramientas para mover leña (palo largo)

**AL COCINAR:**
20. Ollas estables (no se vuelquen)
21. Mangos alejados del fuego
22. Guantes o agarraderas
23. Cuidado con vapor

**APAGAR:**
24. Apaga completamente antes de dormir/salir
25. Rocía con agua, revuelve, más agua
26. Cenizas deben estar frías al tacto
27. Si no puedes poner la mano en cenizas, NO está apagado

**DESPUÉS:**
28. Esparce cenizas frías lejos del camp
29. Desmantela círculo de piedras si lo creaste
30. Restaura área a estado natural

**EMERGENCIAS:**
31. Si fuego se sale de control: agua inmediatamente
32. Si no puedes controlarlo: evacúa y pide ayuda
33. Si ropa prende fuego: PARA, TÍRATE, RUEDA
34. Botiquín accesible para quemaduras
...
1. **Encuentra lugar apropiado:**
   - Área sombreada
   - Tierra suave (fácil de cavar)
   - Lejos de áreas de tránsito
   - No muy cerca del agua (puede inundarse)

2. **Cava el hoyo:**
   - Profundidad: 30-40 cm
   - Ancho: según la cantidad de comida
   - Fondo plano

3. **Prepara interior:**
   - Opcional: forra con plástico o bolsa grande
   - Coloca capa de hojas frescas o pasto en el fondo

4. **Guarda alimentos:**
   - En recipientes cerrados (protección de tierra/insectos)
   - Coloca en el hoyo
   - Los más perecederos al fondo (más frío)

5. **Cubre:**
   - Tapa con tabla o piedra plana
   - Luego tierra o pasto encima
   - Marca el lugar para encontrarlo

**Ventajas:**
- Gratis, no requiere equipo
- Temperatura constante
- Protege de sol

**Desventajas:**
- Trabaja de cavar
- Puede atraer animales cavadores
- Dificulta acceso rápido

**Mejora:** Entierra cantimplora con agua - estará fresca cuando la necesites

**2. MÉTODO DE EVAPORACIÓN (Zeer pot / Desert cooler):**

**Cómo funciona:**
El agua al evaporarse absorbe calor, enfriando el interior.

**Construcción:**

1. **Materiales:**
   - Recipiente grande de barro/cerámica porosa
   - Recipiente más pequeño que quepa dentro
   - Arena o tierra
   - Agua
   - Tela húmeda o tapa

2. **Armado:**
   - Coloca recipiente pequeño dentro del grande
   - Llena espacio entre ambos con arena húmeda
   - Llena hasta 5 cm del borde
   - Moja bien la arena

3. **Uso:**
   - Coloca alimentos en recipiente interno
   - Cubre con tela húmeda
   - Ubica en lugar con brisa y sombra
   - Re-humedece arena 2-3 veces al día

**Ventajas:**
- Enfría activamente (no solo mantiene frío)
- Funciona mejor en clima seco
- Acceso fácil a alimentos

**Desventajas:**
- Requiere agua constante
- Menos efectivo en clima húmedo
- Necesitas los recipientes correctos

**OTROS MÉTODOS:**

**3. INMERSIÓN EN AGUA CORRIENTE:**

**Cómo:**
- Coloca alimentos en bolsa impermeable
- Ata con cuerda
- Sumerge en arroyo o río de agua fría
- Ata la cuerda a orilla

**Ventajas:**
- Muy efectivo si hay corriente fría
- Sin esfuerzo una vez instalado

**Desventajas:**
- Necesitas fuente de agua adecuada
- Riesgo de que se suelte
- Puede atraer animales acuáticos

**4. BOLSA MOJADA CON BRISA:**

**Cómo:**
- Envuelve alimentos en tela
- Moja la tela
- Cuelga en lugar con brisa constante
- Re-humedece cuando se seque
...
**Desventajas:**
- Menos efectivo
- Solo para períodos cortos

**PRINCIPIOS GENERALES PARA MANTENER COMIDA FRESCA:**

1. **Sombra:** Siempre en sombra, nunca sol directo
2. **Ventilación:** Brisa ayuda
3. **Humedad:** Evaporación enfría
4. **Aislación:** Separa de calor externo
5. **Elevación:** Del suelo caliente
6. **Recipientes:** Cerrados (protección)
...
**Prerrequisitos:** Campamento I (recomendado pero no obligatorio)

**Evaluación:**
- Campamento de 2 noches obligatorio
- Observación continua de habilidades
- Verificar filosofía personal escrita y practicada
- Demostración de uso correcto de herramientas

**Diferencias con Campamento I:**
- Requiere mayor responsabilidad
- Más énfasis en cocina (3 técnicas)
- Herramientas (hacha/machete)
- Técnicas de conservación de alimentos
- Mantenimiento de equipo

**Seguridad prioritaria:**
- Supervisión adulta en uso de herramientas
- Fogatas controladas siempre
- Cocina con precaución
- Botiquín accesible
- Conocer ubicación de hospital más cercano

**Consejos pedagógicos:**
- Enseña filosofía personal antes del campamento
- Practica uso de hacha en reuniones previas
- Demuestra técnicas de cocina
- Involucra en planificación completa
- Permite que experimenten bajo supervisión

**Desarrollo espiritual:**
- Participación activa en cultos
