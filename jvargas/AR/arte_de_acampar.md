...
### 2. Preparar una lista de ropas o vestimentas necesarias para campamentos en climas calidos y en climas fríos

**CAMPAMENTO EN CLIMA CALIDO:**
...
3. **Herramientas cortantes:**
 ...
 !["Hacha"]( https://wiki.pathfindersonline.org/w/File:Partes_del_Hacha.png)
...
!["Entregar por el mango"](https://wiki.pathfindersonline.org/w/File:Pasar_el_Hacha.png)
   ...
   - Cortar en angulo de 60 grados, no en angulo recto.

["Hacha en 60 grados"](https://wiki.pathfindersonline.org/w/File:90_grados.png)

   - Entrega herramientas por el mango, nunca por la hoja
   - Guárdalas en su funda cuando no las uses

!["No dejar tirada"](https://wiki.pathfindersonline.org/w/File:No_Deje.png)

4. **Comida:**
   - Guarda alimentos en recipientes cerrados
   - Cuelga la comida en árbol lejos del campamento si hay animales grandes
...
1. **Yesca (iniciador):**
   - Material que prende con chispa: corteza seca, hojas secas, ramitas muy finas, algodon.
...
- No fuerces el corte
- La hoja debe pasar deslizandose sobre la superficie a cortar, recorriendo el filo como en forma de medialuna.
...
- Información médica personal (grupo de sangre, enfermedades de base, etc).
...
- Colihues / Madera para construcciones tipo colgador, zapatero, etc.
...
- Carta topografica del área a visitar
- Brújula o GPS
...
- Sándwiches variados (queso, mantequilla de maní/mermelada, pasta de legumbres/proteína vegetal)

**Valor nutricional:** Carbohidratos (energía rápida), proteínas (huevos), grasas saludables (nueces), vitaminas (fruta).

**ALMUERZO:**

- Fondo: Fideos / tallarines con salsa o Arroz con hamburguesas de soya
- Ensalada: Vegetales crudos (zanahoria, tomate)
...
- Sopa de verduras
- Ensalada mixta
- Pan de ajo, tortillas
- Agua o bebida caliente
- Postre: fruta asada, queque, brownie
...
2. **Considera la actividad física:**
   ...
   - Más actividad = más calorías necesarias. Más frío = más calorias necesarias.
   - Carbohidratos complejos (no refinados) dan energía duradera
...
4. **Hidratación:**
   ...
   - Considerar mínimo 3 litros por persona/día
...
4. **Protección del suelo:**
   ...
   - Coloca lona o huella protectora (footprint) antes que la carpa
     ...
     - La lona debe ser de tamaño adecuado para la carpa.

5. **Orientación:**

   - Puerta de la carpa lejos del viento dominante.
   - Considera apuntar la puerta el sol de la mañana para favorecer tu ciclo circadiano... O si quieres dormir hasta más tarde evita que la puerta dé directamente al sol de la mañana.
...
1. **Extender la carpa:**
   ...
   - Lee las instrucciones cuantas veces lo necesites para asegurar un buen rendimiento.
...
- Practica armar tu carpa __en casa o en el club__ antes del campamento.
...
- Seca la carpa antes de guardarla si hubo humedad o lluvia.
...
2. **Limpiar el área:**
   ...
   - Ten agua o arena en baldes cerca para emergencias.
...
4. **Preparar la fogata:**
   ...
   - ___Nunca cortes árboles vivos__ - usa solo madera caída y seca
...
1. **Comida:**
   ...
   - Pon la comida fuera de alcance con alguna de estas opciones:
     - Cuelga la comida en un árbol a 2-4 metros de altura y 1 metro de distancia del tronco
     - Usa contenedores a prueba de animales
     - Usa una carpa bodega y contenedores o cajas plasticas al interior
...
El Código de Campamentos de los Conquistadores es el conjunto de principios y normas que guían nuestro comportamiento en un campamento. Su significado es recordarme que debo ser un buen mayordomo de la creación de Dios, vivir con orden, respeto, limpieza y responsabilidad, y asegurar la seguridad mía y de mi grupo. Su razón es proteger la vida, cuidar la naturaleza, mantener la disciplina cristiana y crear un ambiente donde podamos aprender, convivir y reflejar el carácter de Jesús durante el campamento.
Debemos mantener en nuestras mentes que:

- El Conquistador es mayordomo de la creación.
- Nada es neutro en el gran conflicto: acampar también es un acto espiritual.
- El campamento es un entorno para fortalecer carácter cristiano, respeto, disciplina, servicio y espíritu misionero.

El Código existe para que el Conquistador:

- Cuide la creación de Dios (mayordomía ambiental).
- Se proteja y proteja al grupo (seguridad).
- Mantenga orden, disciplina y respeto en un ambiente donde los riesgos aumentan.
- Desarrolle hábitos cristianos en convivencia real: respeto, limpieza, obediencia, reverencia, compañerismo.
- Aprenda habilidades reales para la vida: responsabilidad, autocontrol, trabajo en equipo.
- Refleje el carácter de Cristo incluso en situaciones desafiantes.
