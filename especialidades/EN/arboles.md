...
classDiagram
    class HERBARIO {
        +String proyecto: Especialidad Conquistadores
        +String área: Árboles
    }
    ...
    HERBARIO --> IDENTIFICACIÓN : contiene
    IDENTIFICACIÓN --> CARACTERÍSTICAS : describe
    CARACTERÍSTICAS --> RECOLECCIÓN : documentada en

    note for IDENTIFICACIÓN "Ejemplo:\\nQuercus robur\\nRoble común\\nFagaceae"
    note for CARACTERÍSTICAS "Ejemplo:\\n20-40 metros\\nSimple, lobulada\\nGris, agrietada\\nBellota\\nBosques templados"
    note for RECOLECCIÓN "Ejemplo:\\nParque Central, Ciudad\\n15 de marzo de 2024\\n[Tu nombre]"
```
