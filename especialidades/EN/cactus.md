...
* **Areolas:** La característica distintiva más importante. Son pequeños cojines o protuberancias de donde nacen las espinas, flores, ramas y pelos. Ninguna otra familia de plantas las tiene.
  ...
  <div align="center">
    <img src="https://upload.wikimedia.org/wikipedia/commons/f/f7/Opuntia_microdasys_01_ies_cropped.jpg" alt="Areolas de cactus Opuntia microdasys" width="350">
    <p><em>Areolas de Opuntia microdasys — los pequeños cojines de donde nacen las espinas. (CC BY-SA 3.0, Frank Vincentz)</em></p>
  </div>
...
* **Raíces:** Generalmente superficiales y muy extendidas horizontalmente para captar la mayor cantidad de agua de lluvia en poco tiempo. Algunas especies también desarrollan una raíz gruesa (napiforme) para almacenar reservas.
  ...
  <div align="center">
    <img src="https://upload.wikimedia.org/wikipedia/commons/b/b0/Cut_Cereus_%28brightened%29.jpg" alt="Corte transversal de cactus Cereus" width="350">
    <p><em>Corte transversal de un Cereus — se observa el tejido verde exterior que realiza fotosíntesis y el interior que almacena agua. (Dominio público, Tangopaso)</em></p>
  </div>
...
```mermaid
graph TD
    FL["🌸 Flor<br/>Nace de la areola"]
    FR["🍎 Fruto<br/>Se desarrolla de la flor"]
    ES["📌 Espinas<br/>Hojas modificadas"]
    AR["⚪ Areola<br/>Cojín exclusivo de los cactus"]
    CO["📏 Costillas<br/>Pliegues del tallo"]
    TA["🟢 Tallo<br/>Almacena agua y hace fotosíntesis"]
    RA["🌱 Raíces<br/>Superficiales y extensas"]
...
1. **Quisco (*Echinopsis chiloensis*):** Nativo de Chile. Cactus columnar de gran altura (hasta 8 m) con espinas largas. Muy común en cerros de la zona central. Produce frutos comestibles llamados "quiscos".
   ...
   <div align="center">
     <img src="https://upload.wikimedia.org/wikipedia/commons/6/62/Trichocereus_chiloensis_1.jpg" alt="Quisco - Echinopsis chiloensis" width="300">
     <p><em>Quisco (<i>Echinopsis chiloensis</i>). (CC BY-SA 3.0, Stan Shebs)</em></p>
   </div>
...
2. **Tuna o Nopal (*Opuntia ficus-indica*):** Tallos planos en forma de paletas (cladodios) y frutos comestibles. Ampliamente cultivado en Chile y México para alimentación.
   ...
   <div align="center">
     <img src="https://upload.wikimedia.org/wikipedia/commons/d/d0/Opuntia_ficus-indica.JPG" alt="Tuna - Opuntia ficus-indica" width="300">
     <p><em>Tuna con frutos maduros (<i>Opuntia ficus-indica</i>). (CC BY-SA 3.0, Archenzo)</em></p>
   </div>
...
3. **Quisquito (*Eriosyce subgibbosa*):** Cactus globular pequeño, nativo de la costa y valles centrales de Chile. Produce flores rosadas llamativas.
   ...
   <div align="center">
     <img src="https://upload.wikimedia.org/wikipedia/commons/6/6d/Neoporteria_subgibbosa_%281%29.jpg" alt="Quisquito - Eriosyce subgibbosa" width="300">
     <p><em>Quisquito en flor (<i>Eriosyce subgibbosa</i>). (CC BY 2.0, Pato Novoa)</em></p>
   </div>
...
4. **Asiento de suegra (*Echinocactus grusonii*):** Forma de barril con espinas amarillas brillantes. Originario de México, en peligro de extinción en estado silvestre.
   ...
   <div align="center">
     <img src="https://upload.wikimedia.org/wikipedia/commons/b/bc/Echinocactus_grusonii_001.JPG" alt="Asiento de suegra - Echinocactus grusonii" width="300">
     <p><em>Asiento de suegra (<i>Echinocactus grusonii</i>). (CC BY-SA 3.0, H. Zell)</em></p>
   </div>
...
5. **Cactus de Navidad (*Schlumbergera truncata*):** Cactus epífito (crece sobre árboles) que florece en invierno. No tiene espinas visibles.
   ...
   <div align="center">
     <img src="https://upload.wikimedia.org/wikipedia/commons/0/01/Schlumbergera_truncata_02.JPG" alt="Cactus de Navidad - Schlumbergera truncata" width="300">
     <p><em>Cactus de Navidad en flor (<i>Schlumbergera truncata</i>). (CC BY-SA 2.5, Lestat)</em></p>
   </div>
...
6. **Saguaro (*Carnegiea gigantea*):** El icónico cactus de los desiertos de Arizona con forma de "brazos". Puede alcanzar 15 metros y vivir más de 150 años.
   ...
   <div align="center">
     <img src="https://upload.wikimedia.org/wikipedia/commons/c/cd/Carnegiea_gigantea_in_Saguaro_National_Park_near_Tucson%2C_Arizona_during_November_%2858%29.jpg" alt="Saguaro - Carnegiea gigantea" width="300">
     <p><em>Saguaro en su hábitat natural (<i>Carnegiea gigantea</i>). (CC BY-SA 3.0, WClarke)</em></p>
   </div>

7. **Cactus Dedo (*Mammillaria elongata*):** Cilindros delgados que crecen en grupos densos. Popular como planta de interior.

   <div align="center">
     <img src="https://upload.wikimedia.org/wikipedia/commons/5/50/MammillariaElongata2.jpg" alt="Cactus Dedo - Mammillaria elongata" width="300">
     <p><em>Cactus Dedo (<i>Mammillaria elongata</i>). (Dominio público, Chhe)</em></p>
   </div>
...
8. **Pitahaya (*Hylocereus undatus*):** Cactus trepador famoso por su fruto exótico (fruta del dragón). Sus flores enormes abren solo de noche.
   ...
   <div align="center">
     <img src="https://upload.wikimedia.org/wikipedia/commons/e/ed/Hylocereus_undatus_1.jpg" alt="Pitahaya - Hylocereus undatus" width="300">
     <p><em>Flor de Pitahaya (<i>Hylocereus undatus</i>). (CC BY-SA 3.0, Brocken Inaglory)</em></p>
   </div>
...
9. **Cereus (*Cereus hildmannianus*):** Cactus columnar de crecimiento rápido. Usado frecuentemente como cerco vivo en zonas rurales.
   ...
   <div align="center">
     <img src="https://upload.wikimedia.org/wikipedia/commons/5/58/Cereus_hildmannianus_subsp._uruguayanus_-_Peruvian_Torch_Flowers.jpg" alt="Cereus hildmannianus" width="300">
     <p><em>Cereus en floración (<i>Cereus hildmannianus</i>). (CC BY-SA 2.0, William Herron)</em></p>
   </div>
...
10. **Antorcha de Plata (*Cleistocactus strausii*):** Cubierto de pelos blancos finos que le dan aspecto plateado. Nativo de Bolivia.
    ...
    <div align="center">
      <img src="https://upload.wikimedia.org/wikipedia/commons/5/56/Cleistocactus_strausii_Woolly_Torch%2C_Huntington_Desert_Garden.jpg" alt="Antorcha de Plata - Cleistocactus strausii" width="300">
      <p><em>Antorcha de Plata (<i>Cleistocactus strausii</i>). (CC BY-SA 2.0, Pamla J. Eisenberg)</em></p>
    </div>

11. **Birrete de Obispo (*Astrophytum ornatum*):** Forma estrellada con escamas blancas decorativas sobre sus costillas.

    <div align="center">
      <img src="https://upload.wikimedia.org/wikipedia/commons/d/dc/Astrophytum_ornatum5.jpg" alt="Birrete de Obispo - Astrophytum ornatum" width="300">
      <p><em>Birrete de Obispo (<i>Astrophytum ornatum</i>). (Dominio público, Chrizz)</em></p>
    </div>
...
12. **Cactus Injertado (*Gymnocalycium mihanovichii*):** El famoso cactus rojo o amarillo. No puede hacer fotosíntesis por sí solo, así que debe vivir injertado sobre otro cactus verde.
    ...
    <div align="center">
      <img src="https://upload.wikimedia.org/wikipedia/commons/e/e5/Side_Moon_Cactus_Ooty_Jun25_A7CR_05698-764_zsp.jpg" alt="Cactus Injertado - Gymnocalycium mihanovichii" width="300">
      <p><em>Cactus Injertado rojo sobre portainjerto verde (<i>Gymnocalycium mihanovichii</i>). (CC BY-SA 4.0, Timothy A. Gonsalves)</em></p>
    </div>

13. **Cactus Barril Azul (*Ferocactus glaucescens*):** Tono azulado (glauco) y forma globular. Produce pequeñas flores amarillas.

    <div align="center">
      <img src="https://upload.wikimedia.org/wikipedia/commons/1/12/Ferocactus_glaucescens1000.jpg" alt="Cactus Barril Azul - Ferocactus glaucescens" width="300">
      <p><em>Cactus Barril Azul (<i>Ferocactus glaucescens</i>). (CC BY-SA 2.5, Christer Johansson)</em></p>
    </div>
...
14. **Rebutia (*Rebutia muscula*):** Pequeño, globular y cubierto de espinas blancas suaves. Florece abundantemente en primavera con flores anaranjadas.
    ...
    <div align="center">
      <img src="https://upload.wikimedia.org/wikipedia/commons/e/ea/Rebutia_muscula.JPG" alt="Rebutia muscula" width="300">
      <p><em>Rebutia en flor (<i>Rebutia muscula</i>). (Dominio público, Chilepine)</em></p>
    </div>
...
15. **Peyote (*Lophophora williamsii*):** Cactus pequeño, sin espinas, de forma redondeada y aplanada. Crece muy lentamente en desiertos de México y Texas.
    ...
    <div align="center">
      <img src="https://upload.wikimedia.org/wikipedia/commons/6/6d/Peyote_Cactus.jpg" alt="Peyote - Lophophora williamsii" width="300">
      <p><em>Peyote en su hábitat natural (<i>Lophophora williamsii</i>). (Dominio público, U.S. Fish and Wildlife Service)</em></p>
    </div>
