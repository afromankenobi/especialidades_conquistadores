...
```
        ┌─────────────────────┐
        │      LIMBO          │ ← Lámina o parte plana y ancha
        │   (blade/blade)     │   Donde ocurre la fotosíntesis
        │                     │
        │    ┌──── Ápice      │ ← Punta de la hoja
        │    │                │
        │   ╱│╲ Nervadura     │ ← Venas que transportan agua y nutrientes
        │  ╱ │ ╲ central      │   (también dan estructura)
        │ ╱  │  ╲             │
        │╱───┴───╲            │
        └──────────┘          │
         Nervaduras ──────────┘
         secundarias
              ...
              │  ← PECIOLO (tallo que une la hoja al tallo)
              │    Permite orientación hacia la luz
              │
        ┌─────┴─────┐
        │  ESTÍPULAS │ ← Apéndices pequeños en la base (no todas las hojas los tienen)
        └───────────┘
              │
          ────┴──── ← AXILA FOLIAR (ángulo entre peciolo y tallo)
          TALLO          donde pueden crecer yemas
```
...
┌─────────────────────────────────────┐
│ HERBARIO - Árboles                  │
│ Proyecto: Especialidad Conquistadores │
├─────────────────────────────────────┤
│ NOMBRE CIENTÍFICO: Quercus robur    │
│ NOMBRE COMÚN: Roble común           │
│ FAMILIA: Fagaceae                   │
├─────────────────────────────────────┤
│ CARACTERÍSTICAS DEL ÁRBOL:          │
│ - Altura: 20-40 metros              │
│ - Hoja: Simple, lobulada            │
│ - Corteza: Gris, muy agrietada      │
│ - Fruto: Bellota                    │
│ - Hábitat: Bosques templados        │
├─────────────────────────────────────┤
│ LUGAR DE RECOLECCIÓN:               │
│ Parque Central, Ciudad               │
│                                     │
...
**Requisitos teóricos (1-3, 6-10):**
- Pueden evaluarse oralmente o por escrito
- Verificar comprensión real de conceptos

**Requisito 4-5 (Herbario):**
- **Calidad del herbario:**
  - Hojas bien prensadas y secas (no mohosas)
  - Montaje limpio y ordenado
  - Etiquetas completas y correctas
  - Variedad de especies (no repetir)
- **Identificación en campo:**
  - Al menos 80% correctas (12 de 15)
  - Evaluación práctica en parque o bosque

**Requisito 8 (Texto):**
- Mínimo 300 palabras
- Contenido: servicios ecosistémicos, biodiversidad, amenazas, soluciones
- Debe incluir perspectiva cristiana/bíblica
- Ejemplos específicos de su región

**Requisito 10 (Historias bíblicas):**
- Puede ser presentación oral
- Debe explicar el significado espiritual, no solo contar la historia

### Consejos de enseñanza:

**Salidas de campo:**
- Organizar caminata por parque o bosque
- Llevar guías de campo
- Recolectar hojas para herbario grupal
- Tomar fotos de árboles completos

**Proyecto de herbario:**
- Puede ser proyecto de varias semanas
- Asignar tiempo en reuniones para prensar/montar hojas
- Compartir equipo (prensas, papel periódico)
- Hacer galería de herbarios terminados

**Actividades complementarias:**
- Plantar un árbol como club
- Adoptar un árbol para monitorear su crecimiento
- Invitar a un ingeniero forestal o biólogo
- Visitar vivero o jardín botánico

### Materiales necesarios:

**Para herbario:**
- Tijeras o navajas
- Papel periódico (mucho)
- Cartones
- Libros pesados o prensa
- Cartulinas blancas
- Pegamento
- Etiquetas o papel para etiquetar

**Para salida de campo:**
- Guía de árboles de la región
- Cuadernos y lápices
- Cámara (teléfono)
- Lupa (opcional pero útil)
- Cinta métrica (medir troncos)

### Seguridad:

⚠️ **Importante:**
- Enseñar a identificar plantas tóxicas locales
- No comer ningún fruto/hoja sin identificación segura
- Usar repelente de insectos en bosques
- Supervisión constante en salidas
- Cuidado con árboles con espinas
- No trepar árboles durante la especialidad

### Tiempo estimado:

- **Requisitos teóricos:** 4-6 horas de clase
- **Herbario (colecta, prensado, montaje):** 3-4 semanas
- **Memorización:** 2-3 semanas de estudio personal
- **Salida de campo:** 1 día (4-6 horas)
- **Total:** 6-8 semanas de proyecto

### Conexión con otras especialidades:

Esta especialidad se complementa bien con:
- **Flores** (EN-005)
- **Arbustos** (EN-079)
- **Semillas** (EN-040)
- **Ecología** (EN-044)
- **Conservación ambiental** (EN-046)
